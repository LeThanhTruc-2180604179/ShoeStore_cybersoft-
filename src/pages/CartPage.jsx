  ...
  return (
    <div className="w-full flex flex-col md:flex-row gap-8">
            ...
            <div key={item.id} className="flex gap-4 items-start border-b pb-4 mb-4">
              <div className="flex flex-col items-center">
                ...
                <div className="flex gap-2 mt-1">
                  ...
                  <button className="border border-black text-black bg-white px-2 py-1 rounded-full hover:border-2 transition" onClick={() => handleChangeQty(item.id, 1)}>+</button>
                  <button className="text-black bg-white p-2 rounded-full hover:bg-gray-100 transition" title="Wishlist">
                    <HeartIcon />
                  </button>
                </div>
              </div>
      ...
      <div className="w-full md:w-80 bg-white rounded-lg shadow p-6 h-fit">
        ...
        <button className="w-full py-3 mb-2 bg-black text-white rounded-full font-semibold hover:bg-gray-800 transition">Guest Checkout</button>
        <button className="w-full py-3 bg-black text-white rounded-full font-semibold hover:bg-gray-800 transition">Member Checkout</button>
      </div>
    </div>
  );
};
